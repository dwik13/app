                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button href="#" class="btn btn-success btn-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" title="edit" data-target="#exampleModalmenuedit<?= $r['id'] ?>">Edit</button>

                                <button onclick="hapusRole('<?= base_url('admin/hapusrole/') . $r['id'] ?>')" id="tombol-hapus-role" class="btn btn-danger btn-sm tombol-hapus ">Delete</button>
...
<!-- Modal -->
<div class="modal fade" id="Addnewrole" tabindex="-1" aria-labelledby="newRoleModalLabel" aria-hidden="true">
